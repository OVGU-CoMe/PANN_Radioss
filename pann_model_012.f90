...
contains
  ...
  subroutine load_nn_params()
    ...
    K = 3.34941619705895903e+02_dp
    G = 3.34941619705895921e-01_dp

    ! -----------------------------
    ! Layer 1: W1_MAT(5,2)
    ! -----------------------------
    W1_MAT(1,1) = 9.59297979487586279e-03_dp
    W1_MAT(1,2) = 4.24461749664615795e-07_dp
    W1_MAT(2,1) = 2.85353781885561819e-01_dp
    W1_MAT(2,2) = 6.81215943898273779e-01_dp
    W1_MAT(3,1) = 2.04024153429259780e-01_dp
    W1_MAT(3,2) = 3.27018085970901829e-08_dp
    W1_MAT(4,1) = 9.18260524707273512e-02_dp
    W1_MAT(4,2) = 4.36300720152440421e-12_dp
    W1_MAT(5,1) = 2.93601395665652409e-01_dp
    W1_MAT(5,2) = 2.58865649108586606e-05_dp

    ! Layer 1: b1_VEC(5)
    b1_VEC(1) = -5.97115873111896178e-01_dp
    b1_VEC(2) = -5.58964695851211446e-01_dp
    b1_VEC(3) = -6.81407455398122686e+00_dp
    b1_VEC(4) = -7.88836723395510742e+00_dp
    b1_VEC(5) = 1.84126502958735685e+01_dp

    ! -----------------------------
    ! Layer 2: W2_MAT(1,5)
    ! -----------------------------
    W2_MAT(1,1) = 1.27447829295857674e-02_dp
    W2_MAT(1,2) = 1.30974123113002333e-04_dp
    W2_MAT(1,3) = 1.04629411280879783e-01_dp
    W2_MAT(1,4) = 3.30124886772518025e+01_dp
    W2_MAT(1,5) = 5.63979314360676831e-01_dp
